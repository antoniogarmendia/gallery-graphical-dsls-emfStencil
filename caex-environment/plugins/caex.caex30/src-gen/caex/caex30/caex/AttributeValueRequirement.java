 ...
 * </p>
 * <ul>
 *   <li>{@link caex.caex30.caex.AttributeValueRequirement#getOrdinalScaledType <em>Ordinal Scaled Type</em>}</li>
 *   <li>{@link caex.caex30.caex.AttributeValueRequirement#getNominalScaledType <em>Nominal Scaled Type</em>}</li>
 *   <li>{@link caex.caex30.caex.AttributeValueRequirement#getUnknownType <em>Unknown Type</em>}</li>
 *   <li>{@link caex.caex30.caex.AttributeValueRequirement#getName <em>Name</em>}</li>
 * </ul>
 *
 * @see caex.caex30.caex.CAEXPackage#getAttributeValueRequirement()
...
public interface AttributeValueRequirement extends CAEXBasicObject {
	 ...
	 * @see caex.caex30.caex.CAEXPackage#getAttributeValueRequirement_UnknownType()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link caex.caex30.caex.AttributeValueRequirement#getUnknownType <em>Unknown Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see caex.caex30.caex.CAEXPackage#getAttributeValueRequirement_Name()
	...
	/**
	 * Sets the value of the '{@link caex.caex30.caex.AttributeValueRequirement#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
