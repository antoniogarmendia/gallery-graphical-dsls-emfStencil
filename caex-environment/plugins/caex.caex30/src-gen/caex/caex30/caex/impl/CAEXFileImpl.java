...
public class CAEXFileImpl extends CAEXBasicObjectImpl implements CAEXFile {
	...
	public EList<InstanceHierarchy> getInstanceHierarchy() {
		if (instanceHierarchy == null) {
			instanceHierarchy = new EObjectContainmentEList.Resolving<InstanceHierarchy>(InstanceHierarchy.class, this, CAEXPackage.CAEX_FILE__INSTANCE_HIERARCHY);
		}
	...
	public EList<InterfaceClassLib> getInterfaceClassLib() {
		if (interfaceClassLib == null) {
			interfaceClassLib = new EObjectContainmentEList.Resolving<InterfaceClassLib>(InterfaceClassLib.class, this, CAEXPackage.CAEX_FILE__INTERFACE_CLASS_LIB);
		}
	...
	public EList<RoleClassLib> getRoleClassLib() {
		if (roleClassLib == null) {
			roleClassLib = new EObjectContainmentEList.Resolving<RoleClassLib>(RoleClassLib.class, this, CAEXPackage.CAEX_FILE__ROLE_CLASS_LIB);
		}
		return roleClassLib;
	}
	...
	public EList<SystemUnitClassLib> getSystemUnitClassLib() {
		if (systemUnitClassLib == null) {
			systemUnitClassLib = new EObjectContainmentEList.Resolving<SystemUnitClassLib>(SystemUnitClassLib.class, this, CAEXPackage.CAEX_FILE__SYSTEM_UNIT_CLASS_LIB);
		}
