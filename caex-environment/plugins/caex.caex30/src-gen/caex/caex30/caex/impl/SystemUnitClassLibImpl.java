 ...
 * </p>
 * <ul>
 *   <li>{@link caex.caex30.caex.impl.SystemUnitClassLibImpl#getSystemUnitClass <em>System Unit Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SystemUnitClassLibImpl extends CAEXObjectImpl implements SystemUnitClassLib {
	...
	public EList<SystemUnitClass> getSystemUnitClass() {
		if (systemUnitClass == null) {
			systemUnitClass = new EObjectContainmentEList.Resolving<SystemUnitClass>(SystemUnitClass.class, this, CAEXPackage.SYSTEM_UNIT_CLASS_LIB__SYSTEM_UNIT_CLASS);
		}
