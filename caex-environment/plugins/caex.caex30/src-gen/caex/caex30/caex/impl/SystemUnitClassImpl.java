...
public class SystemUnitClassImpl extends CAEXObjectImpl implements SystemUnitClass {
	...
	public EList<InternalElement> getInternalElement() {
		if (internalElement == null) {
			internalElement = new EObjectContainmentEList.Resolving<InternalElement>(InternalElement.class, this, CAEXPackage.SYSTEM_UNIT_CLASS__INTERNAL_ELEMENT);
		}
	...
	public EList<InternalLink> getInternalLink() {
		if (internalLink == null) {
			internalLink = new EObjectContainmentEList.Resolving<InternalLink>(InternalLink.class, this, CAEXPackage.SYSTEM_UNIT_CLASS__INTERNAL_LINK);
		}
		return internalLink;
	}
