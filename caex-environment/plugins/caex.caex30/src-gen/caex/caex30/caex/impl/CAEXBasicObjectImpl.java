...
public class CAEXBasicObjectImpl extends MinimalEObjectImpl.Container implements CAEXBasicObject {
	...
	public Description getDescription() {
		if (description != null && description.eIsProxy()) {
			...
			if (description != oldDescription) {
				...
				NotificationChain msgs = oldDescription.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CAEXPackage.CAEX_BASIC_OBJECT__DESCRIPTION, null, null);
				if (newDescription.eInternalContainer() == null) {
					msgs = newDescription.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CAEXPackage.CAEX_BASIC_OBJECT__DESCRIPTION, null, msgs);
				}
	...
	public Version getVersion() {
		if (version != null && version.eIsProxy()) {
			...
			if (version != oldVersion) {
				...
				NotificationChain msgs = oldVersion.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CAEXPackage.CAEX_BASIC_OBJECT__VERSION, null, null);
				if (newVersion.eInternalContainer() == null) {
					msgs = newVersion.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CAEXPackage.CAEX_BASIC_OBJECT__VERSION, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
	...
	public EList<Revision> getRevision() {
		if (revision == null) {
			revision = new EObjectContainmentEList.Resolving<Revision>(Revision.class, this, CAEXPackage.CAEX_BASIC_OBJECT__REVISION);
		}
		return revision;
	}
	...
	public Copyright getCopyright() {
		if (copyright != null && copyright.eIsProxy()) {
			...
			if (copyright != oldCopyright) {
				...
				NotificationChain msgs = oldCopyright.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CAEXPackage.CAEX_BASIC_OBJECT__COPYRIGHT, null, null);
				if (newCopyright.eInternalContainer() == null) {
					msgs = newCopyright.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CAEXPackage.CAEX_BASIC_OBJECT__COPYRIGHT, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
	...
	public EList<AdditionalInformation> getAdditionalInformation() {
		if (additionalInformation == null) {
			additionalInformation = new EObjectContainmentEList.Resolving<AdditionalInformation>(AdditionalInformation.class, this, CAEXPackage.CAEX_BASIC_OBJECT__ADDITIONAL_INFORMATION);
		}
