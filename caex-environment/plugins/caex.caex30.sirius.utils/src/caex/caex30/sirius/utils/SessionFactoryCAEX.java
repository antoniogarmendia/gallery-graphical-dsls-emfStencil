package caex.caex30.sirius.utils;
...
public class SessionFactoryCAEX implements SessionFactory {
    ...
    public Session createSession(final URI sessionResourceURI, IProgressMonitor monitor) throws CoreException {
        ...
        if (resource instanceof XMIResource) {
        	XMIResource airdResorce = (XMIResource) resource;
        	//Support the CAEX XML Metadata
    		...
    		airdResorce.getDefaultLoadOptions().put(XMLResource.OPTION_EXTENDED_META_DATA, extendedMetaData);
    		airdResorce.getDefaultSaveOptions().put(XMLResource.OPTION_EXTENDED_META_DATA, extendedMetaData);
    		//End        	
        }
        return session;
    }
