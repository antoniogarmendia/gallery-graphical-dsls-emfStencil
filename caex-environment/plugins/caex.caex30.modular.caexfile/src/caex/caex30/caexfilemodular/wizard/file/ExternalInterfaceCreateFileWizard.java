...
public class ExternalInterfaceCreateFileWizard extends Wizard implements INewWizard {
	private ExternalInterfaceCreateFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for ExternalInterfaceCreateFileWizard.
	 */
	public ExternalInterfaceCreateFileWizard() {
		super();
	...
	public void addPages() {
		page = new ExternalInterfaceCreateFileWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(
		...
		ExternalInterface rootObject = CAEXFactoryImpl.eINSTANCE.createExternalInterface();
		//Set the Attributes
		...
		((EList<EObject>)file_xmi.Get_Root().eGet(file_xmi.Get_Root().eClass().getEStructuralFeature("interfaceClass"), true)).add(child_xmi.Get_Root());
		file_xmi.Save_XMI();
