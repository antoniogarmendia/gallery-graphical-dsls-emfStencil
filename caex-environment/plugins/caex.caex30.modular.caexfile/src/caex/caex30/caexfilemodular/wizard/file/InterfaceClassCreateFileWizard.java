...
public class InterfaceClassCreateFileWizard extends Wizard implements INewWizard {
	private InterfaceClassCreateFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for InterfaceClassCreateFileWizard.
	 */
	public InterfaceClassCreateFileWizard() {
		super();
	...
	public void addPages() {
		page = new InterfaceClassCreateFileWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(
		...
		InterfaceClass rootObject = CAEXFactoryImpl.eINSTANCE.createInterfaceClass();
		//Set the Attributes
