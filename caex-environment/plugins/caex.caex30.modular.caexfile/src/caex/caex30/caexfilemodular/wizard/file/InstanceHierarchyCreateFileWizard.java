...
public class InstanceHierarchyCreateFileWizard extends Wizard implements INewWizard {
	private InstanceHierarchyCreateFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for InstanceHierarchyCreateFileWizard.
	 */
	public InstanceHierarchyCreateFileWizard() {
		super();
	...
	public void addPages() {
		page = new InstanceHierarchyCreateFileWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(
		...
		InstanceHierarchy rootObject = CAEXFactoryImpl.eINSTANCE.createInstanceHierarchy();
		//Set the Attributes
		...
		((EList<EObject>)file_xmi.Get_Root().eGet(file_xmi.Get_Root().eClass().getEStructuralFeature("instanceHierarchy"), true)).add(child_xmi.Get_Root());
		file_xmi.Save_XMI();
