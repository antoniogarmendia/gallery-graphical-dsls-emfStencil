...
public class InternalElementCreateFileWizard extends Wizard implements INewWizard {
	private InternalElementCreateFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for InternalElementCreateFileWizard.
	 */
	public InternalElementCreateFileWizard() {
		super();
	...
	public void addPages() {
		page = new InternalElementCreateFileWizardPage(selection);
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		final String attr_refBaseSystemUnitPath = page.Get_refBaseSystemUnitPath();	
	...
	private void doFinish(
		...
		String attr_refBaseSystemUnitPath,	
		...
		InternalElement rootObject = CAEXFactoryImpl.eINSTANCE.createInternalElement();
		//Set the Attributes
		...
		rootObject.setRefBaseSystemUnitPath(attr_refBaseSystemUnitPath);
