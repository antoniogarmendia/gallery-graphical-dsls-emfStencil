...
public class InterfaceClassLibCreateFolderWizard extends Wizard implements INewWizard {
	private InterfaceClassLibCreateFolderWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for InterfaceClassLibCreateFolderWizard.
	 */
	public InterfaceClassLibCreateFolderWizard() {
		super();
	...
	public void addPages() {
		page = new InterfaceClassLibCreateFolderWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(
		...
		//Create Root
		InterfaceClassLib root_obj = CAEXFactoryImpl.eINSTANCE.createInterfaceClassLib();
		//Set the Attributes
		...
		((EList<EObject>)file_xmi.Get_Root().eGet(file_xmi.Get_Root().eClass().getEStructuralFeature("interfaceClassLib"), true)).add(folder_xmi.Get_Root());
		file_xmi.Save_XMI();				
