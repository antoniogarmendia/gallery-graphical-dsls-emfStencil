...
public class SystemUnitFamilyCreateFileWizard extends Wizard implements INewWizard {
	private SystemUnitFamilyCreateFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for SystemUnitFamilyCreateFileWizard.
	 */
	public SystemUnitFamilyCreateFileWizard() {
		super();
	...
	public void addPages() {
		page = new SystemUnitFamilyCreateFileWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(
		...
		SystemUnitFamily rootObject = CAEXFactoryImpl.eINSTANCE.createSystemUnitFamily();
		//Set the Attributes
