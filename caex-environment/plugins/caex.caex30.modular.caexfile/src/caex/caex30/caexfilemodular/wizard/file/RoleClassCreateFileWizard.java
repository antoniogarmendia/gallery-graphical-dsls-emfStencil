...
public class RoleClassCreateFileWizard extends Wizard implements INewWizard {
	private RoleClassCreateFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for RoleClassCreateFileWizard.
	 */
	public RoleClassCreateFileWizard() {
		super();
	...
	public void addPages() {
		page = new RoleClassCreateFileWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(
		...
		RoleClass rootObject = CAEXFactoryImpl.eINSTANCE.createRoleClass();
		//Set the Attributes
		...
		((EList<EObject>)file_xmi.Get_Root().eGet(file_xmi.Get_Root().eClass().getEStructuralFeature("roleClass"), true)).add(child_xmi.Get_Root());
		file_xmi.Save_XMI();
