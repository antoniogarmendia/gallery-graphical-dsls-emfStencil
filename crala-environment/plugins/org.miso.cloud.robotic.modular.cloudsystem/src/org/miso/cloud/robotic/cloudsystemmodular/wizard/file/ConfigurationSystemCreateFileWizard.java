...
public class ConfigurationSystemCreateFileWizard extends Wizard implements INewWizard {
	private ConfigurationSystemCreateFileWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for ConfigurationSystemCreateFileWizard.
	 */
	public ConfigurationSystemCreateFileWizard() {
		super();
	...
	public void addPages() {
		page = new ConfigurationSystemCreateFileWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(
		...
		ConfigurationSystem rootObject = cloudRoboticsFactoryImpl.eINSTANCE.createConfigurationSystem();
		//Set the Attributes
		...
		((EList<EObject>)file_xmi.Get_Root().eGet(file_xmi.Get_Root().eClass().getEStructuralFeature("configSystems"), true)).add(child_xmi.Get_Root());
		file_xmi.Save_XMI();
