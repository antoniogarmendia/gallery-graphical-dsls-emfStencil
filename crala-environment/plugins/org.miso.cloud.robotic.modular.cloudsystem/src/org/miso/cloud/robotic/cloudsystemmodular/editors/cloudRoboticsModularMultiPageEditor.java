...
import cloudRobotics.presentation.cloudRoboticsEditor;

public class cloudRoboticsModularMultiPageEditor extends cloudRoboticsEditor implements IFilterTabItem{
	...
	public void createPages() {
		...
		// Create a page for the Filter view.
		{
			FilterAttribute anFilterAttribute = new FilterAttribute(getSite().getPage(),
												cloudRoboticsModularMultiPageEditor.this, getSite().getShell().getDisplay(),
