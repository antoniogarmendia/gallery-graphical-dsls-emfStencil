...
/**
 * This is the item provider adapter for a {@link cloudRobotics.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigurationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 cloudRoboticsPackage.Literals.CONFIGURATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(cloudRoboticsPackage.Literals.CONFIGURATION__CONFIG_SYSTEMS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Configuration.class)) {
			case cloudRoboticsPackage.CONFIGURATION__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case cloudRoboticsPackage.CONFIGURATION__CONFIG_SYSTEMS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(cloudRoboticsPackage.Literals.CONFIGURATION__CONFIG_SYSTEMS,
				 cloudRoboticsFactory.eINSTANCE.createConfigurationSystem()));
	}
