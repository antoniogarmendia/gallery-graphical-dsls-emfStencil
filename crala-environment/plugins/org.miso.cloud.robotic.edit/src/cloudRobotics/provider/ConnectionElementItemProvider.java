...
/**
 * This is the item provider adapter for a {@link cloudRobotics.ConnectionElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 cloudRoboticsPackage.Literals.CONNECTION_ELEMENT__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 cloudRoboticsPackage.Literals.CONNECTION_ELEMENT__TARGET,
				 true,
				 false,
				 true,
				 null,
