...
/**
 * This is the item provider adapter for a {@link cloudRobotics.Robot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RobotItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 cloudRoboticsPackage.Literals.ROBOT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(cloudRoboticsPackage.Literals.ROBOT__SENSORS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Robot.class)) {
			case cloudRoboticsPackage.ROBOT__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case cloudRoboticsPackage.ROBOT__SENSORS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(cloudRoboticsPackage.Literals.ROBOT__SENSORS,
				 cloudRoboticsFactory.eINSTANCE.createSensorType()));
	}
