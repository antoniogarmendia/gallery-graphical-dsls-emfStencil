...
/**
 * This is the item provider adapter for a {@link cloudRobotics.VirtualMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualMachineItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 cloudRoboticsPackage.Literals.VIRTUAL_MACHINE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(cloudRoboticsPackage.Literals.VIRTUAL_MACHINE__COMPONENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VirtualMachine.class)) {
			case cloudRoboticsPackage.VIRTUAL_MACHINE__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case cloudRoboticsPackage.VIRTUAL_MACHINE__COMPONENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(cloudRoboticsPackage.Literals.VIRTUAL_MACHINE__COMPONENTS,
				 cloudRoboticsFactory.eINSTANCE.createComponentClass()));

		newChildDescriptors.add
			(createChildParameter
				(cloudRoboticsPackage.Literals.VIRTUAL_MACHINE__COMPONENTS,
				 cloudRoboticsFactory.eINSTANCE.createWebService()));
	}
